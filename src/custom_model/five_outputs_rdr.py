...
@DatasetReader.register("five_outputs")
class FiveOutputsTextClassificationJsonReader(TextClassificationJsonReader):
    """
    ...
    The output of `read` is a list of `Instance` s with the fields:
        ...
        labels2 : `LabelField` and
        labels3 : `LabelField` and
        labels4 : `LabelField` and
        labels5 : `LabelField`
    Registered as a `DatasetReader` with name "five_outputs".
    ...
    num_labels1, num_labels2, num_labels3, num_labels4, num_labels5 : `int`, optional (default=`None`)
    ...
    def __init__(
            ...
            num_labels3: Optional[int] = None,
            num_labels4: Optional[int] = None,
            num_labels5: Optional[int] = None,
            **kwargs,
    ) -> None:
        super().__init__(
            tokenizer=tokenizer,
    ...
    def _read(self, file_path: str) -> Iterable[Instance]:
        ...
        with open(file_path, "r") as data_file:
            for line in data_file.readlines():
                ...
                text = items["text"]
                labels1 = items.get("label1")
                labels2 = items.get("label2")
                labels3 = items.get("label3")
                labels4 = items.get("label4")
                labels5 = items.get("label5")

                instance = self.text_to_instance(text=text,
                                                 labels1=labels1, labels2=labels2, labels3=labels3,
                                                 labels4=labels4, labels5=labels5)
    ...
    def text_to_instance(
            ...
            labels3: Union[str, int] = None,
            labels4: Union[str, int] = None,
            labels5: Union[str, int] = None,
        ...
        if labels3 is not None:
            fields["label3"] = LabelField(
                labels3, skip_indexing=self._skip_label_indexing,
                label_namespace='labels3',
            )
        if labels4 is not None:
            fields["label4"] = LabelField(
                labels4, skip_indexing=self._skip_label_indexing,
                label_namespace='labels4',
            )
        if labels5 is not None:
            fields["label5"] = LabelField(
                labels5, skip_indexing=self._skip_label_indexing,
                label_namespace='labels5',
            )
